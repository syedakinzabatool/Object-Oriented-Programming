...
{
    cout << "Enter a binary number: "; // Prompting the user to enter a binary number
...
{
    cout << "Displaying your binary number: "; // Displaying a message indicating that the binary number is being displayed
    for (int i = 0; i < s.length(); i++)
    {
